...
- (void)setupLayout
{
    ...
    self.containerView.frame = CGRectMake(1, 55, [UIScreen mainScreen].bounds.size.width-2, 250);
...
- (void)setupFrame
{
    ...
    self.containerView.layer.anchorPoint = CGPointMake(0.5, 0);
    self.containerView.frame = CGRectMake(1, 55, [UIScreen mainScreen].bounds.size.width-2, height);
