...
//        dTextIn = [[DES decodeBase64WithString:sTextIn] mutableCopy];
        //防止泄露
        dTextIn =(NSMutableData*)[DES decodeBase64WithString:sTextIn];
    }
    else{
//        dTextIn = [[sTextIn dataUsingEncoding: EnC] mutableCopy];
        //防止泄露
        dTextIn = (NSMutableData*)[sTextIn dataUsingEncoding: EnC];
    }
//    NSMutableData * dKey = [[sKey dataUsingEncoding:EnC] mutableCopy];
    //防止泄露
    NSMutableData * dKey = (NSMutableData*)[sKey dataUsingEncoding:EnC];
...
+ (NSString *)encodeBase64WithData:(NSData *)objData {
	...
	long intLength = (long)[objData length];
...
+ (NSData *)decodeBase64WithString:(NSString *)strBase64 {
	...
	int intLength = (unsigned)strlen(objPointer);
	int intCurrent;
	int i = 0, j = 0, k;
